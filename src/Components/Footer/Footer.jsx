  ...
  <div className="flex space-x-4 mb-4">
    ...
    <a href="https://www.youtube.com" aria-label="YouTube">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-7" viewBox="0 0 576 512">
        <path fill="#FF0000" d="M549.7 124.1c-6.3-23.7-24.8-42.3-48.3-48.6C458.8 64 288 64 288 64S117.2 64 74.6 75.5c-23.5 6.3-42 24.9-48.3 48.6-11.4 42.9-11.4 132.3-11.4 132.3s0 89.4 11.4 132.3c6.3 23.7 24.8 41.5 48.3 47.8C117.2 448 288 448 288 448s170.8 0 213.4-11.5c23.5-6.3 42-24.2 48.3-47.8 11.4-42.9 11.4-132.3 11.4-132.3s0-89.4-11.4-132.3zm-299.4 206.8V181.8l149.1 82.6-149.1 82.6z"/>
      </svg>
    </a>
  </div>
</div>
        ...
        <div className="flex flex-col">
          ...
          <p className="text-sm font-light mb-2">Email: <a href="mailto:info@tuneuptech.in" className="hover:text-blue-500">info@tuneuptech.in</a></p>
          <p className="text-sm font-light">Phone: <a href="tel:+919944500207" className="hover:text-blue-500">+91 99445 00207</a></p>
        </div>
      </div>
