...
const Footer = () => {
 ...
 <div className="flex flex-col items-center md:items-start">
  ...
  <div className="flex space-x-5 ml-1 mb-4">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" className="h-7" viewBox="0 0 576 512">
        ...
        <div className="flex flex-col">
          ...
          <ul className="text-sm font-light flex flex-col space-y-2">
            <li className="hover:text-blue-500 cursor-pointer">Our Products</li>
            <li className="hover:text-blue-500 cursor-pointer">Our Founder</li>
            <li className="hover:text-blue-500 cursor-pointer">Premium Offers</li>
